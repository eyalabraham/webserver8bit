/* ***************************************************************************
  ...
  system/OS architecture header file for lwIP on FlashLite v25 SBC
...
*
* Created and empty function just in case it is needed.
*
...
*
* the following functionas are already provided as empty macros in sys.h
*
...
*
* implemented these for LMTE and DOS use in 'sys_arch.c'
*
...
perf.h     - Architecture specific performance measurement.
             included if LWIP_PERF is set to 1 on lwipopts.h
