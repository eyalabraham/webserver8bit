...
/* -----------------------------------------
   function prototypes
----------------------------------------- */
void    vt100_lcd_init(int, uint16_t, uint16_t);        // initialize the module with display orientation and background/foreground colors
int     vt100_lcd_columns(void);                        // LCD text columns
int     vt100_lcd_rows(void);                           // LCD text rows
void    vt100_lcd_putc(char);                           // output a character through VT100 driver
