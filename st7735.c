 ...
 *
 */
static void delay(uint16_t miliSec)
{
    uint16_t oneMs = ONE_MILI_SEC;
 ...
 *
 */
static spiDevErr_t lcdWriteCommand(uint8_t byte)
{
 ...
 *
 */
static spiDevErr_t lcdWriteData(uint8_t byte)
{
 ...
 *
 */
int lcdFrameBufferPush(uint8_t* frameBufferPointer, void(*completionCallBack)(void))
{
    uint16_t  size;
 ...
 * return: none
 */
void lcdDrawChar(uint16_t x, uint16_t y, char c, uint16_t textColor, uint16_t bgColor, int scale)
{
