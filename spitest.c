...
#include    "ip/enc28j60.h"                     // ENC28J60 Ethernet device
...
static int    readControlRegister(ctrlReg_t, uint8_t*);
static int    writeControlRegister(ctrlReg_t, uint8_t);
static int    readPhyRegister(phyReg_t, uint16_t*);
static int    controlBit(ctrlReg_t, uint8_t);
static int    setControlBit(ctrlReg_t, uint8_t);
static int    clearControlBit(ctrlReg_t, uint8_t);
...
uint16_t                phyID1 = 0, phyID2 = 0, phyCON1 = 0;
uint8_t                 ethReg;
...
static int readControlRegister(ctrlReg_t reg, uint8_t* byte)
{
    uint8_t    bank;
    uint8_t    regId;
    uint8_t    regValue;
...
static int writeControlRegister(ctrlReg_t reg, uint8_t byte)
{
    uint8_t    bank;
    uint8_t    regId;
    uint8_t    regValue;
...
static int readPhyRegister(phyReg_t reg, uint16_t* word)
{
    uint8_t    byte;
    int     result = SPI_RD_ERR;
...
static int setControlBit(ctrlReg_t reg, uint8_t position)
{
    uint8_t    bank;
    uint8_t    regId;
    uint8_t    regValue;
...
static int clearControlBit(ctrlReg_t reg, uint8_t position)
{
    uint8_t    bank;
    uint8_t    regId;
    uint8_t    regValue;
